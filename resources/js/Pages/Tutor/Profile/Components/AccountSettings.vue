    ...
    <div class="p-2">
      <div class="mt-7">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-5">
          ...
          <PasswordInput :label="t('current_password')" v-model="form.current_password"
            :errors="form.errors.current_password" name="current_password" />

          <PasswordInput :label="t('password')" v-model="form.password" :errors="form.errors.password" name="password" />

          <PasswordInput :label="t('confirm_password')" v-model="form.password_confirmation"
