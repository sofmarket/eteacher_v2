    ...
    <div class="lg:w-1/3">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="text-center">
                <!-- Profile Image -->
                <div
                    class="w-32 h-32 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span class="text-4xl font-bold text-white">{{ getInitials(tutor?.name || 'Tutor Name') }}</span>
                </div>

                <!-- Name and Verification -->
                <div class="flex items-center justify-center mb-2">
                    <h1 class="text-2xl font-bold text-gray-900">{{ tutor.profile.full_name }}</h1>
                ...
                <p class="text-gray-600 mb-4">Verified</p>
                <p class="text-lg text-gray-700 mb-6">{{ tutor.profile.tagline }}</p>

                <!-- Pricing -->
                <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                    <div class="text-center">
                        <span class="text-3xl font-bold text-green-600">{{ tutor.min_price }}</span>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600">{{ tutor.avg_rating || '0' }}/5.0 ({{ tutor.total_reviews }}
                            review)</p>
                    </div>
                    <div class="text-center">
                        <p class="text-2xl font-bold text-gray-900">{{ tutor.active_students }}</p>
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ tutor.response_time || '2 Hours' }}</p>
                </div>
