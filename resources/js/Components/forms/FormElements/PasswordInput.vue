    ...
    <div :class="parentClasses">
        ...
        <div class="relative">
            ...
            <span v-if="togglePassword === true" class="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400"
                ...
                <svg v-if="hidePassword" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
        ...
        <p class="text-error-500 mt-2" v-if="errors" v-cloak>{{ errors }}</p>
...
export default {
    ...
    props: {
        ...
        inputClasses: {
            type: String,
            default: 'dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800'
        },
        required: {
            type: Boolean,
            default: false
    ...
    emits: ['update:modelValue', 'input', 'keypress'],
    methods: {
        handleInput(event) {
